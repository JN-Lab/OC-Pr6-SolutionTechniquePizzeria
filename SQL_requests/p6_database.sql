...
CREATE TABLE IF NOT EXISTS `p6_project`.`utilisateur` (
  ...
  `password` VARCHAR(255) CHARACTER SET 'utf8' NOT NULL COMMENT 'A passer en CHAR(40) si SHA1 ou CHAR(32) si md5',
...
CREATE TABLE IF NOT EXISTS `p6_project`.`commande` (
  ...
  INDEX `fk_commande_id_restaurant_restaurant_id` (`id_restaurant` ASC),
  ...
  CONSTRAINT `fk_commande_id_mode_reglement_mode_reglement_id`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_commande_id_restaurant_restaurant_id`
...
CREATE TABLE IF NOT EXISTS `p6_project`.`evolution_preparation` (
  ...
  `date_fin_operation` DATETIME NULL,
...
-- -----------------------------------------------------
-- Table `p6_project`.`stock_ingredient_par_restaurant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `p6_project`.`stock_ingredient_par_restaurant` ;

CREATE TABLE IF NOT EXISTS `p6_project`.`stock_ingredient_par_restaurant` (
  `id_ingredient` INT UNSIGNED NOT NULL,
  `id_restaurant` INT UNSIGNED NOT NULL,
  `quantite_allouee` DECIMAL(10,2) NULL,
  PRIMARY KEY (`id_ingredient`, `id_restaurant`),
  INDEX `fk_stock_ingredient_par_restaurant_id_restaurant_restaurant_id` (`id_restaurant` ASC),
  INDEX `fk_stock_ingredient_par_restaurant_id_ingredient_ingredient_id` (`id_ingredient` ASC),
  CONSTRAINT `fk_stock_ingredient_par_restaurant_id_ingredient_ingredient_id`
    FOREIGN KEY (`id_ingredient`)
    REFERENCES `p6_project`.`ingredient` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_stock_ingredient_par_restaurant_id_restaurant_restaurant_id`
    FOREIGN KEY (`id_restaurant`)
    REFERENCES `p6_project`.`restaurant` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `p6_project`.`disp_pizza_par_rest`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `p6_project`.`disp_pizza_par_rest` ;

CREATE TABLE IF NOT EXISTS `p6_project`.`disp_pizza_par_rest` (
  `id_pizza` INT UNSIGNED NOT NULL,
  `id_restaurant` INT UNSIGNED NOT NULL,
  `disponibilite` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`id_pizza`, `id_restaurant`),
  INDEX `fk_disp_pizza_par_rest_id_restaurant_restaurant_id` (`id_restaurant` ASC),
  INDEX `fk_disp_pizza_par_rest_id_pizza_pizza_id` (`id_pizza` ASC),
  CONSTRAINT `fk_disp_pizza_par_rest_id_pizza_pizza_id`
    FOREIGN KEY (`id_pizza`)
    REFERENCES `p6_project`.`pizza` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_disp_pizza_par_rest_id_restaurant_restaurant_id`
    FOREIGN KEY (`id_restaurant`)
    REFERENCES `p6_project`.`restaurant` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
