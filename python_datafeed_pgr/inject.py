        ...
        while numb_customer < number:
            customer = {
                ...
                "delivery_address" : {
                    ...
                    "zip_code" : self.fake_data.zipcode(),
                    "info_bonus" : self.fake_data.random_element(elements=("appt A", "appt B", "appt C", "code entree = 123456")),
                ...
                "invoice_address" : {
                    ...
                    "street_number" : self.fake_data.random_int(min=1, max=250),
                    "zip_code" : self.fake_data.zipcode(),
                    "info_bonus" : self.fake_data.secondary_address(),
                    "city" : self.fake_data.city(),
                    "phone_number" : self.fake_data.phone_number()}
                }
